...
<body>
    ...
    <main>
        ...
        <div class="containers">
            ...
            <div class="post-info">
                <div class="post-info-left">
                    ...
                    <span class="post-info-item">작성일: <c:out value="${to.noticepostDate}" /></span>
                    <span class="post-info-item">조회수: <c:out value="${to.noticeHit}" /></span>
                </div>
            </div>
        ...
        <c:if test="${not empty prevPost}">
            <input type="button" value="이전글" class="btn" onclick="location.href='adminnotice_view.do?noticeSeq=${prevPost.noticeSeq}&cpage=${param.cpage}&searchType=${param.searchType}&searchKeyword=${fn:escapeXml(param.searchKeyword)}'" />
        </c:if>
        <c:if test="${not empty nextPost}">
            <input type="button" value="다음글" class="btn" onclick="location.href='adminnotice_view.do?noticeSeq=${nextPost.noticeSeq}&cpage=${param.cpage}&searchType=${param.searchType}&searchKeyword=${fn:escapeXml(param.searchKeyword)}'" />
        </c:if>
    </div>
