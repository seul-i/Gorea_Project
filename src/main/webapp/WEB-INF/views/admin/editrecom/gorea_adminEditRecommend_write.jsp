...
<body>
    ...
    <main>
        ...
        <div class="containers">
            ...
            <form class="form-horizontal" name="wfrm" method="post" action="./adminEditReco_write_ok.do">
                ...
                <div class="form-group">
                    <textarea class="form-control" id="noticeContent" name="editrecoContent" placeholder="내용을 입력해 주세요."></textarea>
                </div>
