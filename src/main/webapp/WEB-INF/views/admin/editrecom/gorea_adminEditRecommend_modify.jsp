...
<body>
    ...
    <main>
        ...
        <div class="containers">
            ...
            <form action="./adminEditReco_modify_ok.do" method="post" name="mfrm" enctype="multipart/form-data" class="form-horizontal">
                <c:set var="to" value="${requestScope.to}" />
                <input type="hidden" name="editrecoSeq" value="${param.editrecoSeq}" /> 
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="${to.editrecoSubject}" name="editrecoSubject" style="height: 50px" />
                </div>
                <div class="form-group">
                    <div class="stits">
                        <p>부제목</p>
                    </div>
                    <input type="text" class="form-control" value="${to.editrecoSubtitle}" name="editrecoSubtitle" style="height: 50px" />
                </div>
            
                <div class="form-group">
                    <textarea class="form-control" id="noticeContent" name="editrecoContent">${to.editrecoContent}</textarea>
                </div>
                <div class="btn_wrap">
