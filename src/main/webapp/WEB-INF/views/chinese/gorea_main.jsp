...
<body>
	...
	<jsp:include page="/WEB-INF/views/chinese/includes/header.jsp"></jsp:include>
...
<!-- 							<h4 style="font-weight:bold;">역사와 현대가 공존하는 문화와 쇼핑의 중심지</h4> -->
							<h2 style="font-weight:bold;">东 大 门</h2>
						</header>
					</div>
			</article>
			...
			<article>
				<img src="/img/main/sungsu.jpg" alt="" width="1440" height="962">
					<div class="inner">
						<header>
							<h2 style="font-weight:bold;">圣 水 洞</h2>
						</header>
					</div>
			</article>
			...
			<article>
				<img src="/img/main/gang.jpg" width="1440" height="961">
					<div class="inner">
						<header>
							<h2 style="font-weight:bold;">广 藏 市 场</h2>
						</header>
					</div>
			</article>
			...
			<article>
				<img src="/img/main/nowon.jpg" width="1440" height="962">
					<div class="inner">
						<header>
							<h2 style="font-weight:bold;">芦 原</h2>
						</header>
					</div>
			</article>
		</section>
