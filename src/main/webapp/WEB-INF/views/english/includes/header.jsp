...
<!-- 	    						<option value="/chinese/main.do">Chinese</option> -->
								<option value="/korean/trend_seoul.do">korean</option>
								<option value="/japanese/trend_seoul.do">Japanese</option>
								<option value="/chinese/trend_seoul.do">Chinese</option>
	                		</select>
	                	</li>
	                	<li>
