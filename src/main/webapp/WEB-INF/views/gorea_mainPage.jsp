	...
	<div class="carousel slide" id="carouselDemo" data-bs-wrap="true" data-bs-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item " data-bs-interval="3000">
				...
				<div class="carousel-caption">	
					<c:choose>
                        <c:when test="${language eq 'korean'}">서울의 겨울</c:when>
                        <c:when test="${language eq 'english'}">Winter in Seoul</c:when>
                        <c:when test="${language eq 'japanese'}">ソウルの冬</c:when>
                        <c:when test="${language eq 'chinese'}">首尔的冬天</c:when>
                    </c:choose>
            	</div>
			</div>
        	...
        	<div class="carousel-item " data-bs-interval="3000">
        		<c:choose>
                        <c:when test="${language eq 'korean'}"><img src="/img/main/slide1.png" class="w-100"></c:when>
                        <c:when test="${language eq 'english'}"><img src="/img/main/slide2.png" class="w-100"></c:when>
                        <c:when test="${language eq 'japanese'}"><img src="/img/main/slide4.png" class="w-100"></c:when>
                        <c:when test="${language eq 'chinese'}"><img src="/img/main/slide3.png" class="w-100"></c:when>
                </c:choose>
            	<div class="carousel-caption">				
            	</div>
        	</div>
