...
<body>
	...
	<jsp:include page="/WEB-INF/views/japanese/includes/header.jsp"></jsp:include>
...
<!-- 							<h4 style="font-weight:bold;">역사와 현대가 공존하는 문화와 쇼핑의 중심지</h4> -->
							<h2 style="font-weight:bold;">東 大 門</h2>
						</header>
					</div>
			</article>
			...
			<article>
				<img src="/img/main/gangnam.jpg" width="1440" height="961">
					<div class="inner">
						<header>
							<h2 style="font-weight:bold;">江 南</h2>
			...
			<article>
				<img src="/img/main/sungsu.jpg" alt="" width="1440" height="962">
					<div class="inner">
						<header>
							<h2 style="font-weight:bold;">聖 水 洞</h2>
						</header>
					</div>
			</article>
			...
			<article>
				<img src="/img/main/gang.jpg" width="1440" height="961">
					<div class="inner">
						<header>
							<h2 style="font-weight:bold;">広 蔵 市 場</h2>
						</header>
					</div>
			</article>
			...
			<article>
				<img src="/img/main/nowon.jpg" width="1440" height="962">
					<div class="inner">
						<header>
							<h2 style="font-weight:bold;">蘆 原</h2>
						</header>
					</div>
			</article>
		</section>
